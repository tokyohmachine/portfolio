      ...
      submit(values)
        .then((response) => {
          if (response.type === "success") {
            onOpen("success", `All good! Thanks for your submission, ${values.firstName}, we will get back to you shortly!`);
            formik.resetForm();
          } else {
        ...
        .catch((error) => {
          onOpen("error", "There was an error in your submission. Please check your input and try again.");
        });
    },
